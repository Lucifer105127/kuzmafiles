...
module.exports.run = async function({ api, event, args, Currencies }) {
			...
			let win = false;
			if (isNaN(coin)|| coin.indexOf("-") !== -1) return api.sendMessage(`Your bet amount is not a number, please review usage at ${prefix}menu baucuaca`, threadID, messageID);
