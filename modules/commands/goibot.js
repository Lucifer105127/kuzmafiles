...
if(input2.includes("haha") || input2.includes("lmao") || input2.includes("lol") || input2.includes("😂") || input2.includes("😹") || input2.includes("🤣") || input2.includes("😆") || input2.includes("😄") || input2.includes("😅") || input2.includes("xd")){
    ...
    if(input2.includes("kawawa") || input2.includes("sad") || input2.includes("agoi") || input2.includes("sakit") ||input2.includes("skit") || input2.includes("pain") || input2.includes("aguy") ||input2.includes("pighati")){
					        	return api.setMessageReaction("😢", event.messageID, (err) => {}, true)
    }
    if(input2.includes("kazuma") || input2.includes("Kazuma") || input2.includes("Kuzma") || input2.includes("KAZUMA")){
					        	return api.setMessageReaction("💗", event.messageID, (err) => {}, true)
    }
    if(input2.includes("jazer") || input2.includes("Jazer") || input2.includes("JAZER") || input2.includes("jaze")){
					        	return api.setMessageReaction("😠", event.messageID, (err) => {}, true)
    }
