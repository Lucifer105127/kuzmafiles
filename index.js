...
var uptimelink = [`https://d99d6e60-e3f4-4ffb-ba7b-1f258c7a9de6-00-2qg3n3t5q4t6l.worf.replit.dev/`]
...
monitor.on('up', (res) => console.log(chalk.bold.hex("#BF00FF")("[ Prince ] ❯ ") + chalk.hex("#BF00FF")(`${res.website}`)))
